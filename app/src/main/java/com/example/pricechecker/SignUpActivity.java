...
public class SignUpActivity extends AppCompatActivity {
    ...
    public EditText username, emailadd, gender_s, fullName, birthDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gender_s = findViewById(R.id.gender_signup);
        birthDate = findViewById(R.id.birthdate_signup);
        birthDate.addTextChangedListener(new BirthdateTextWatcher(birthDate,true));
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                User user = new User(uname, email, pwd, fname, gender, birthdate);
